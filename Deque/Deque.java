...
class Deque
   {
   private int maxSize;
   private DoublyLinkedList dequeList;
   private int right;
   private int left;
//--------------------------------------------------------------
   public void displayRightToLeft()
   {
      dequeList.displayBackward();
   }
//--------------------------------------------------------------
...
//--------------------------------------------------------------      
   public void insertLeft(long j)   // put item at left of deque
      {
         dequeList.insertFirst(j);        // one more item
      }
//--------------------------------------------------------------
...
//--------------------------------------------------------------      
   public void insertRight(long j)   // put item at left of deque
      {
          dequeList.insertLast(j);         // one more item
      }
//--------------------------------------------------------------
...
class DequeApp
   ...
   public static void main(String[] args)
      {
      Deque theDeque = new Deque();  // deque holds up to 100 million items   
